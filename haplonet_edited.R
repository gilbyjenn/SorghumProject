## This is an adapted version of haplonet.R writted by mhoban https://github.com/mhoban/haplonet
## The script has been edited to force the use of big-palette and writing out a legend without command line arguments specifically for this project
...
# EDIT 
legend(x='topleft',legend=categories,fill=pal,bty="n",cex=0.8,ncol=2)
title(main = "Orthogroup 2: 650 Gene")
